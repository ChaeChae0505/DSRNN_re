...
class CrowdSimDict(CrowdSim):
    ...
    def set_robot(self, robot):
        ...
        d['visible_mask'] = gym.spaces.Box(low=-np.inf, high=np.inf, shape=(self.human_num, 1), dtype=np.float32)
    ...
    def generate_ob(self, reset):
        ...
        ob['visible_mask'] = np.zeros((self.human_num, 1))
        for i in range(self.human_num):
            ...
            ob['visible_mask'][i] = 1.0*self.human_visibility[i]
