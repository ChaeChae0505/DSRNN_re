...
class EdgeAttention(nn.Module):
    ...
    def att_func(self, temporal_embed, spatial_embed, visible_mask, h_spatials):
        seq_len, nenv, num_edges, h_size = h_spatials.size()  # [1, 12, 30, 256] in testing,  [12, 30, 256] in training
        attn = temporal_embed * spatial_embed * visible_mask
    ...
    def forward(self, h_temporal, h_spatials, visible_mask):
        ...
        for i in range(self.num_attention_head):
            ...
            try:
                ...
                print('hello')
            weighted_value,attn=self.att_func(temporal_embed, spatial_embed, visible_mask, h_spatials)
...
class SRNN(nn.Module):
    ...
    def forward(self, inputs, rnn_hxs, masks, infer=False):
        ...
        visible_mask = reshapeT(inputs['visible_mask'], seq_length, nenv )
        ...
        hidden_attn_weighted, _ = self.attn(output_temporal, output_spatial, visible_mask)
